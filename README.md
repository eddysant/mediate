...
double digits, single digits are zero-padded (`[01]`…`[10]`, widening again
past 99) so lexical order matches numeric order. Series are per directory + base name + site +
